...
urlpatterns = [
    ...
    url(r'user/coupon/index.html$', views.user.coupon, name='user_coupon'),
    url(r'user/coupon/usestate.html$', views.user.coupon_used, name='coupon_used'),
    url(r'user/coupon/expired.html$', views.user.coupon_expired, name='coupon_expired'),
    url(r'user/recmomend.html$', views.user.recmomend, name='recmomend_index'),
    url(r'user/recmomend_count.html$', views.user.recmomend_count, name='recmomend_count'),
    url(r'user/recmomend_detail.html$', views.user.recmomend_detail, name='recmomend_detail'),
    ...
    url(r'packages/(\d+).html', views.product.pacakage_index, name='pacakage_index'),
    ...
    url(r'package/(\d+).html', views.product.pp_buy, name='pp_buy'),
    ...
    url(r'coupon_add.html', views.pay.coupon_add, name='shopping_coupon_add'),
    url(r'coupon_del.html', views.pay.coupon_del, name='shopping_coupon_del'),

    url(r'buy_info.html', views.pay.buy_info, name='shopping_buy'),
    url(r'pay/(\d+).html', views.pay.pay, name='shopping_pay'),
    url(r'pay/weixin/(\d+).html', views.pay.weixin, name='shopping_weixin'),
    ...
    url(r'wxpay/return/', views.pay.wxpay_ruturn_url, name='wxpay_return_url'),
