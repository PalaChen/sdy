...
class Articles(models.Model):
    ...
    creat_date = models.DateTimeField(blank=True, null=True, auto_now_add=True)
...
class OrderPayment(models.Model):
    ...
    p_sub_time = models.DateTimeField(db_column='p_Sub_Time', blank=True, null=True,
                                      auto_now_add=True)
    p_finish_time = models.DateTimeField(db_column='p_Finish_Time', blank=True, null=True)  # Field name made lowercase.
    p_u = models.ForeignKey('Users', models.DO_NOTHING, db_column='p_U_id', blank=True,
                            null=True)
    p_p = models.ForeignKey('Orders', models.DO_NOTHING, db_column='p_P_id', blank=True,
                            null=True)
