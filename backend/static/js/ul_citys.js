...
;(function (factory) {
    ...
    $.fn.citys = function (parameter, getApi) {
        ...
        var defaults = {
            dataUrl: '/admin/area/citys.html',     //数据库地址
        ...
        return this.each(function () {
            ...
            var _api = {};
            var $this = $(this);
            var $province = $this.find('ul[name="' + options.provinceField + '"]'),
                $city = $this.find('ul[name="' + options.cityField + '"]'),
                $area = $this.find('ul[name="' + options.areaField + '"]');
            $.ajax({
                url: options.dataUrl,
                type: 'GET',
                crossDomain: true,
                ...
                success: function (data) {
                    ...
                    var format = {
                        province: function () {
                            $province.empty();
                            if (!options.required) {
                                $province.append('<li value=""> - 请选择 - </li>');
                            }
                            for (var i in province) {
                                $province.append('<li value="' + i + '">' + province[i] + '</li>');
                            }
                            if (options.province) {
                        ...
                        city: function () {
                            ...
                            for (var i in city) {
                                $city.append('<li value="' + i + '">' + city[i] + '</li>');
                            }
                            if (options.city) {
                        ...
                        area: function () {
                            ...
                            if (!hasCity) {
                                ...
                                for (var i in area) {
                                    $area.append('<li value="' + i + '">' + area[i] + '</li>');
                                }
                                if (options.area) {
